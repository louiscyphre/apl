...
ALIASES["apl-2017"] = [
   ...
   "hmy=my_heuristic(tz_first = 203304688, tz_second = 320934904 )",
    ...
    "--search", """iterated([
                     lazy_greedy([hmy, hff],preferred=[hff, hmy]),
                     lazy_wastar([hmy, hff],preferred=[hff, hmy],w=5),
                     lazy_wastar([hmy, hff],preferred=[hff, hmy],w=3),
                     lazy_wastar([hmy, hff],preferred=[hff, hmy],w=2),
                     lazy_wastar([hmy, hff],preferred=[hff, hmy],w=1)
                     ],repeat_last=true,continue_on_fail=true)"""]
