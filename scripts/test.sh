...
#../fast-downward/fast-downward.py $PUZZLE_DOM $PUZZLE_PROB1 --search "lazy(tiebreaking([sum([$MY_H,$ADD_H])]),max_time=20)"
../fast-downward/fast-downward.py $PUZZLE_DOM $PUZZLE_PROB1 --search "lazy(tiebreaking([$ADD_H,$MY_H]),max_time=20)"
